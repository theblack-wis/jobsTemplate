            ...
            function showlog(tok){
                ...
                switch(tok.name){
                    ...
                    case '3':
                        ...
                        Cookies.set('phone', $('#inputphone').val(), { expires: 365 });
